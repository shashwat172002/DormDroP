            ...
            <p className="text:xl sm:text-3xl font-bold text-center mb-5">Total Numbers of orders received by you: <span className="rounded-md p-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white sm:">{senders.length}</span></p>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {senders.map((sender, index) => (
                  <div key={index} className="relative bg-gradient-to-r from-indigo-300 via-purple-300 to-pink-300 text-black text-xl rounded-lg shadow-md p-4 transition-transform transform hover:scale-105 hover:z-10 cursor-pointer sender-card" onClick={() => handleSenderClick(sender)}>
                    ...
                    <ul className="relative z-10 text-center font-lobster">
                      <li><span className="">Name:</span> {sender.name}</li>
